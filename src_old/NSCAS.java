...
class NSCAS {
	...
	int maxlb, repnum;
	// 1.000	1.0475	1.13	1.1575	1.2	1.242	1.284	1.326	1.368	1.410
	private final double REP1 = (1.000);
	private final double REP2 = (1.0475);
	private final double REP3 = (1.13);
	private final double REP4 = (1.1575);
	private final double REP5 = (1.2);
	private final double REP6 = (1.242);
	private final double REP7 = (1.284);
	private final double REP8 = (1.326);
	private final double REP9 = (1.368);
	private final double REP10 = (1.410);

			
	//Constructor
	NSCAS (double lifted, double reps) {
