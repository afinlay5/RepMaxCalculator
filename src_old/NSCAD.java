...
class NSCAD {
	...
	int maxlb, repnum;
	// 1.000	1.065	1.13	1.147	1.164	1.181	1.198	1.22	1.232	1.240
	private final double REP1 = (1.000);
	private final double REP2 = (1.065);
	private final double REP3 = (1.13);
	private final double REP4 = (1.147);
	private final double REP5 = (1.164);
	private final double REP6 = (1.181);
	private final double REP7 = (1.198);
	private final double REP8 = (1.22);
	private final double REP9 = (1.232);
	private final double REP10 = (1.240);

			
	//Constructor
	NSCAD (double lifted, double reps) {
